...
ControlObjectSetControlProcFn fn_control_object_set_control_proc = nullptr;
ControlObjectSetUserTypeFn fn_control_object_set_user_type = nullptr;
TouchHandleUnuseControlEventMoveFn fn_touch_handle_unuse_control_event_move = nullptr;
