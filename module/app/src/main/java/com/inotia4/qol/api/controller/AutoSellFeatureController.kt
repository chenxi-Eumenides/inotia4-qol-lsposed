 ...
 * （rarity 1..5 / enhance 1..32 / socket 1..16 / gemTier 1..5 / gemRange 1..5 / specialMask 非 0 位掩码）。
 * 请求体示例：{"enabled":true,"rarity":1,"enhance":0,"socket":0,"gemTier":0,"specialMask":0,"gemRange":0}
 */
@RestController
