...
import com.inotia4.qol.service.enrichment.NameInjector
 ...
 */
class InfoApiServiceCore : InfoApiService {
    ...
    override fun currentMapExits(): String = InfoMapQueries.exits()
    override fun currentMapId(): String = InfoMapQueries.id()
    override fun currentMapUnits(): String = InfoMapQueries.units()
    override fun currentMapEnemies(): String = InfoMapQueries.enemies()
    override fun currentMapInteractives(): String = InfoMapQueries.interactives()
    override fun currentMapDrops(): String = InfoMapQueries.drops()
    override fun currentMapDistance(tx: Int, ty: Int): String = InfoMapQueries.distance(tx, ty)
    ...
    override fun mercenary(): String = InfoMercenaryQueries.all()
    override fun mercenaryList(): String = InfoMercenaryQueries.slots()
    override fun mercenarySlot(slot: Int): String = InfoMercenaryQueries.slot(slot)
    ...
    override fun exp4TextAppearance(): String = InfoSystemQueries.exp4TextAppearance()
    override fun exp5NewPanel(): String = InfoSystemQueries.exp5NewPanel()
    override fun expRestoreAll(): String = InfoSystemQueries.expRestoreAll()
    override fun expStatus(): String = InfoSystemQueries.expStatus()
    override fun settingsUiInject(): String = InfoSystemQueries.settingsUiInject()
    override fun settingsUiStatus(): String = InfoSystemQueries.settingsUiStatus()
    override fun settingsUiRestore(): String = InfoSystemQueries.settingsUiRestore()
    override fun settingsUiOpenOption(): String = InfoSystemQueries.settingsUiOpenOption()
    override fun settingsUiOpenPanel(): String = InfoSystemQueries.settingsUiOpenPanel()
    override fun extensionBagStatusJson(): String = InfoSystemQueries.extensionBagStatusJson()
    override fun extensionBagTestEquip(index: Int, bagType: Int): String = InfoSystemQueries.extensionBagTestEquip(index, bagType)
    override fun extensionBagTestItem(index: Int, slot: Int, category: Int, count: Int): String =
        InfoSystemQueries.extensionBagTestItem(index, slot, category, count)

    override fun shopItems(): String = InfoShopQueries.items()

    override fun health(): String = InfoSystemQueries.health()
