...
internal object PartyActions {
    fun includeParty(mercenarySlot: Int): String =
        LogFile.op("POST /api/character/party/include", "mercSlot=$mercenarySlot") { ActionSupport.attachParty(NativeBridge.nativeOpIncludeParty(mercenarySlot)) }
    fun excludeParty(mercenarySlot: Int): String =
        LogFile.op("POST /api/character/party/exclude", "mercSlot=$mercenarySlot") { ActionSupport.attachParty(NativeBridge.nativeOpExcludeParty(mercenarySlot)) }
    fun discharge(mercenarySlot: Int): String =
        LogFile.op("POST /api/character/party/discharge", "mercSlot=$mercenarySlot") { ActionSupport.attachParty(NativeBridge.nativeOpDischarge(mercenarySlot)) }
